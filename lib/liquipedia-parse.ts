// Pure parsing of the Liquipedia SF6 Tier 1 Tournaments page HTML. No Next.js
// dependency so it can be reused from a Node script (scripts/refresh-tournaments).
...
export function parse(html: string): TournamentYear[] {
