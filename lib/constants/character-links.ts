...
export const CHARACTER_LINKS: Record<string, CharacterLinks> = {
  ...
  dhalsim:  { supercombo: SC+'Dhalsim',  ufd: UFD+'dhalsim', playlist: YT+'PLvZ5t8JLwU9Jcr7KeG-f7nXN1pYdpBZjs', misterCrimson: 'https://www.youtube.com/watch?v=tC_hKBV6aik', discords: ['https://discord.gg/0pw1HkuKuIcoL8th', 'https://discord.gg/EUhC67mjv6'], playersToWatch: [{ name: 'Mister Crimson', twitch: 'mistahcrimson' }] },
  ...
  aki:      { supercombo: SC+'A.K.I.',   ufd: UFD+'aki',    playlist: YT+'PLvZ5t8JLwU9Ly7fIlPDOobExANmvKjr4c', raidhyn: 'https://docs.google.com/spreadsheets/d/1wlBIf_qOsch7nzh26tYGDSEGWp2m2L0XqJAhWxTSEW0/', discords: ['https://discord.gg/a-k-i-1135649494462124065'], videoGuides: [{ title: 'AKI Guide by Broski', url: 'https://www.youtube.com/watch?v=2kBkizvG7eM' }], playersToWatch: [{ name: 'Broski', twitch: 'Broski' }] },
  ...
  juri:     { supercombo: SC+'Juri',     ufd: UFD+'juri',   playlist: YT+'PLvZ5t8JLwU9JTBBhI0EMZ8GqLQ9c3UnaC', raidhyn: 'https://docs.google.com/spreadsheets/d/1RXr0jfyrgh8bpQ0uRoUwm2MxWhFEBKclKEda0O8Z8bo/', discords: ['https://discord.gg/8Xs5ddd'], playersToWatch: [{ name: 'Nephew', twitch: 'Nephewdork' }] },
  ...
  terry:    { supercombo: SC+'Terry',    ufd: UFD+'terry',  playlist: YT+'PLvZ5t8JLwU9J6edj8FFcp5Oh11TRENEfi', raidhyn: 'https://docs.google.com/spreadsheets/d/1vIbP2sGXyX7VG1aghP25MSSPYITigwPlzvqWBq_AonM/', discords: ['https://discord.gg/BcACwFFQxE'], playersToWatch: [{ name: 'Brian_F', twitch: 'Brian_F' }] },
  ...
  cviper:   { supercombo: SC+'C._Viper', ufd: UFD+'cviper', playlist: YT+'PLvZ5t8JLwU9J8zKD-sSQcE-Ek6uHSxQqB', discords: ['https://discord.gg/DyNj2CTJZj'], playersToWatch: [{ name: 'Mister Crimson', twitch: 'mistahcrimson' }] },
  alex:     { supercombo: SC+'Alex',     ufd: UFD+'alex',   playlist: YT+'PLvZ5t8JLwU9L1MFxn3CXKLgAAJol_YiH9', discords: ['https://discord.gg/8qH4zupmEK'], playersToWatch: [{ name: 'Brian_F', twitch: 'Brian_F' }] },
